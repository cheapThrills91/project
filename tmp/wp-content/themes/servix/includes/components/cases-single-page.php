<div class="cases-single-page post-page posts-list">
	...
	<div class="single-post">
		<div class="post">
			<div class="img-header">
				<img src="<?php echo get_template_directory_uri().'/img/case_01.jpg' ?>" alt="Imagem" class="img-responsive image">
			</div>
	...
	<div class="more-info">
		<div class="more">
			<p class="saiba">Saiba mais sobre <a href="<?php echo get_permalink( get_page_by_title( 'Serviços/ Soluções' ) ); ?>" rel="bookmark" class="link" >Serviços/Produtos</a> </p>
		</div>
		<div class="share">
		...
		<a href="<?php echo get_permalink( get_page_by_title( 'cases' ) ); ?>" class="voltar">
			...
			<span class="text">Voltar para cases</span>
		</a>
	</div>
